...
4. Geef een geordende lijst terug met de relevante skills. Gebruik per skill dit formaat:
   - Titel als: `**[nummer]. [Skillnaam]** — *[wanneer uitvoeren, in 3–6 woorden]*`
   ...
   - **Waarmee helpt deze skill**: gebruik het format `([Type output] )[beschrijving]` op basis van de tabel in de sectie **Output van elke skill** onderaan dit bestand. Pas de beschrijving aan op de specifieke use case.

   Sluit de lijst af met een **Niet aanbevolen** sectie voor skills die je hebt overwogen maar niet relevant acht. Gebruik per skill één bulletpoint:
   - `- **[Skillnaam]** — [één zin waarom niet van toepassing op deze use case]`
...
## Output van elke skill

| Skill | Type output | Waarmee helpt deze skill? | Link |
|---|---|---|---|
...
Geef aan welke vervolgstap je wilt zetten, geef als antwoord het bijbehorende cijfer:

1. Bouw de use case voor mij met de aanbevolen skills.
2. Start een of meer specifieke skills (of typ "alle" voor de volledige aanbevolen volgorde).
3. Geef aanvullende context mee die nog niet is besproken, zoals een bestaande repository, technische keuzes of organisatiespecifieke randvoorwaarden.
